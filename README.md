...
- Autonomous background menu crawling/full indexing, universal-link polish, server-side address geocoding/travel-time ranking, and App Store/TestFlight release assets are future slices.
