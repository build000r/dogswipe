...
| iOS build/test/screenshot smoke | CI run `25417582380` passed iOS build, iOS unit tests, and screenshot UI smoke. Local `make ios-ui-test` now covers the reference Discover surface, visible route controls, draggable card advancement, Matches, Vendor, Review, and Profile in isolated screenshot-mode launches. | Done |
