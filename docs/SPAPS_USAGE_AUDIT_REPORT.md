...
- user-scoped discovery, swipes, matches, craving preferences, vendor submissions/resubmissions, and admin review routes derive identity from backend auth context
