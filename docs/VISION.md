...
- The match surface should feel like "It's a Match!" for a hotdog: show the hero dog, price, short ingredient notes, add-ons, and an order CTA before deeper account/admin workflows.
