...
- Vendors can submit hotdog listings with menu/media metadata, but submitted items stay `pending_review` until an approval surface exists.
...
- Vendor approval/admin moderation tooling
- Payments or booking
- Real-time chat
- Recommendation ML
