...
| Backend container publish | GitHub Actions `25429133185` on `main` | pushed `ghcr.io/build000r/dogswipe:0bac35454c3861b5f31a52ce0c65edd9844d4523` and `latest`; full-SHA tag has a readable Docker manifest |
...
- CI publishes a deterministic backend image tag to `ghcr.io/build000r/dogswipe:<full-git-sha>` plus `latest` for `main` pushes that change `backend/**` or `.github/workflows/ci.yml`; a recent verified tag is `ghcr.io/build000r/dogswipe:0bac35454c3861b5f31a52ce0c65edd9844d4523`.
